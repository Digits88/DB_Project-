<%-- 
    ...
    Created on : Jan 12, 2016, 8:59:42 PM
    Author     : Yasiru
--%>
...
<title>Full Detail Application</title>
...
<form class="jotform-form" action="CalculateMarksServlet" method="post" name="form_60080737750454" id="60080737750454" accept-charset="utf-8" novalidate="true">
  ...
  <div class="form-all">
    <ul class="form-section page-section">
      ...
      <input disabled class="form-textbox validate[required]" type="text" size="10" name="appid" id="first_4" value=<%=request.getParameter("full_view")%>>
...
<div>
    ...
    <textarea disabled rows="8" cols="30" id="selected_school">        
    ...
    <script>
        function EnableItems(){
            ...
            document.getElementById('selected_school').disabled = false;
        }
    </script>  
      ...
      <li class="form-line" data-type="control_button" id="id_10">
          ...
          <div style="margin-left:156px" class="form-buttons-wrapper">
            ...
            <input  type="submit" class="form-submit-button" value="Verify">
...
<input type="hidden" name="event_id" value="1452318394919_60080737750454_lRaEyrA">
            </div>
            
            
            
            
    </form><img src="./Event Registration_files/saved_resource" style="display: none;">
