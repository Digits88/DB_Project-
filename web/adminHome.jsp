<%-- 
    Document   : adminHome
    Created on : Jan 19, 2016, 1:46:47 PM
    Author     : Lakshan
--%>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="addDeadline.jsp">Deadline</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="SchoolRegistrationForm.jsp">Add School</a>
                    </li>
                    <li>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="adminView.jsp" class="page-scroll btn btn-xl">Search Now</a>
