...
public class DB_Connection {
	...
	private DB_Connection()throws ClassNotFoundException,SQLException{
		...
		connection=DriverManager.getConnection("jdbc:mysql://localhost/grade_1_admission","Phrixus", "phrixus123");
               // connection=DriverManager.getConnection("jdbc:mysql://localhost/grade_1_admission","root", "qwerty");
	}
